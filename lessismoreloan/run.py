...
from pages import index, predictions, insights, process, confusionmatrix
...
navbar = dbc.NavbarSimple(
    brand='lessismoreloan',
    brand_href='/', 
    children=[
        dbc.NavItem(dcc.Link('Predictions', href='/predictions', className='nav-link')), 
        dbc.NavItem(dcc.Link('Insights', href='/insights', className='nav-link')), 
        dbc.NavItem(dcc.Link('Process', href='/process', className='nav-link')),
        dbc.NavItem(dcc.Link('confusionmatrix', href='/confusionmatrix', className='nav-link')),        
    ],
    sticky='top',
    color='light', 
    light=True, 
        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:geoffreygordonashbrook@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/lineality/lessismoreloan'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://linkedin.com/in/geoffrey-gordon-ashbrook'), 
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/GG_Ashbrook'), 
                ], 
                className='lead'
            )
        )
